...
#define DISPLAYTEMPLATE 4   
 // 1: Standard Display Template, 2: Minimal Template, 3: only Temperatur, 4: weight scale, 20: vertical Display see git Handbook for further information
